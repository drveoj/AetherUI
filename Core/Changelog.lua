...
A.CHANGELOG = {
	{
		...
		date    = "2026-08-24",
		lines   = {
			"/aether diag now says which source delivered other people's casts - the client itself, or LibClassicCasterino. One fight settles whether the library is still doing anything.",
		},
	},
	{
		version = "0.36.7",
		date    = "2026-08-24",
		lines   = {
			"The wide shot leads the README.",
		},
	},
	{
		version = "0.36.6",
	...
	},
	{
		...
		date    = "2026-08-23",
		lines   = {
			"The three shipped layout presets are the real ones, captured in the game: which bars are on, and every position as a fraction of the screen.",
		},
	},
	{
		version = "0.28.0",
		date    = "2026-08-23",
		lines   = {
			"A layout preset now records which of the six numbered action bars are on and sets them exactly - an arrangement designed around six bars has a hole in it with two. Stance, pet, taxi and extra-action bars are left alone.",
		},
	},
	{
		version = "0.27.1",
	...
	},
	{
		...
		date    = "2026-08-23",
		lines   = {
			"presets: a captured layout is printed to chat as well as the copy box, so it can always be copied",
		},
	},
	{
		version = "0.26.3",
	...
	},
	{
		...
		date    = "2026-08-23",
		lines   = {
			"edit boxes: a caret of our own, so you can see where you are typing in a letter",
		},
	},
	{
		version = "0.25.1",
	...
	},
	{
		...
		date    = "2026-08-23",
		lines   = {
			"panels: the client's own windows open clear of the toolbox handle instead of on top of it",
		},
	},
	{
		version = "0.24.2",
	...
	},
	{
		...
		date    = "2026-08-23",
		lines   = {
			"panels: every one of the client's windows in scope is now reskinned and checked in game - the last of them was the group finder",
		},
	},
	{
		version = "0.22.1",
