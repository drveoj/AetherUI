...
A.CHANGELOG = {
	{
		...
		lines   = {
			...
			"The character sheet dresses fully again - a reputation row could stop it part way through, leaving the window in the client's own stone.",
			"Scrolling a list no longer throws an error, and scroll bar thumbs are ours on every window.",
			"Faction headers show the right plus or minus for whether they are open.",
			...
			"Turning a module off and on again redresses its windows rather than leaving Blizzard's art on top of ours.",
