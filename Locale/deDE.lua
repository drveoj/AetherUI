--[[--------------------------------------------------------------------------
	...
	reads half in deDE and half in English rather than carrying a second copy
...
local L = A.Phrases("deDE")

--@localization(locale="deDE", format="lua_additive_table", handle-unlocalized="ignore", escape-non-ascii="false", table-name="L")@
