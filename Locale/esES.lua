--[[--------------------------------------------------------------------------
	...
	reads half in esES and half in English rather than carrying a second copy
...
local L = A.Phrases("esES")

--@localization(locale="esES", format="lua_additive_table", handle-unlocalized="ignore", escape-non-ascii="false", table-name="L")@
