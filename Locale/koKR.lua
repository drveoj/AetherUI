--[[--------------------------------------------------------------------------
	...
	reads half in koKR and half in English rather than carrying a second copy
...
local L = A.Phrases("koKR")

--@localization(locale="koKR", format="lua_additive_table", handle-unlocalized="ignore", escape-non-ascii="false", table-name="L")@
