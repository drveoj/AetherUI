--[[--------------------------------------------------------------------------
	...
	reads half in ruRU and half in English rather than carrying a second copy
...
local L = A.Phrases("ruRU")

--@localization(locale="ruRU", format="lua_additive_table", handle-unlocalized="ignore", escape-non-ascii="false", table-name="L")@
