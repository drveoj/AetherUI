--[[--------------------------------------------------------------------------
	...
	reads half in zhCN and half in English rather than carrying a second copy
...
local L = A.Phrases("zhCN")

--@localization(locale="zhCN", format="lua_additive_table", handle-unlocalized="ignore", escape-non-ascii="false", table-name="L")@
